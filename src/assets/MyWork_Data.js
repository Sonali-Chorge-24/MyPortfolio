...
const MyWork_Data = [
  ...
  {
    w_no: 2,
    w_name: "MX Player — Font Page (UI Only)",
    w_img: project2_img,
    w_desc: "This is a frontend-only UI recreation of the MX Player home screen. Built entirely with HTML and CSS to improve my skills in layout, styling, and user interface design. No JavaScript or backend code was used — the focus was on clean structure, responsiveness, and better visual design practices."
  },
  {
    w_no: 3,
  ...
  },
  {
    ...
    w_video: project4_video,
    w_desc: "Inventory Management System using ASP.NET MVC and SQL Server with a responsive UI built in Bootstrap, HTML, CSS, and JavaScript — handles product stock, sales, and purchase operations."
  }
];
